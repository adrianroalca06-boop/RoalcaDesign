    ...
    <header id="Cabecera1" class="fade-in">
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                <a href="#servicios" class="btn">Descubrir Servicios</a>
            ...
            <div class="servicios-grid">
                <div class="servicio-card">
                    <div class="servicio-icono">
                        <img src="imágenes/icono-diseno.png" alt="Diseño de Interiores">
                    </div>
                ...
                <div class="servicio-card">
                    <div class="servicio-icono">
                        <img src="imágenes/icono-decoracion.png" alt="Decoración">
                    </div>
                ...
                <div class="servicio-card">
                    <div class="servicio-icono">
                        <img src="imágenes/icono-materiales.png" alt="Materiales">
                    </div>
